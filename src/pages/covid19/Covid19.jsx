                    ...
                    <div className="col-md-7 col-sm-12 col-lg-7">
                      <div className="abt-pg-desc">
                        <p itemprop="description">
                          ...
                          support the vulnerable families & make these
                          settlements free from COVID-19. We hereby request you
                          extend your full support for our team to execute the{" "}
                          <strong>COVID-19 Relief Project</strong> Phase 3 in
                          the 6 settlements of South Zone. The duration of Phase
                          3 project is from 1st of May 2021 to 1st of August
                          2021. Every small donation you make will help the
                          vulnerable families at this time of crisis:{" "}
                          <strong>
                            <a href="https://rzp.io/l/lbtcdonate4needy">
                              Donate
                            </a>
                          </strong>
                        </p>
                        ...
                        <p className="thm-clr blc-wt">
                          We at LBTC have been working on ground for the past
                          one year supporting 500+ vulnerable families directly
                          under the ‘Covid19 Relief Project’ in ward 165 & ward
                          166 (South Zone). From April 2021, due to the rise of
                          covid cases, we are expanding our operations to 6
                          settlements (10000+ households), namely:
                          <ul>
                            <li>
                        ...
                        <p className="thm-clr blc-wt">
                          ...
                          <ul>
                            ...
                            <li>
                              Connecting vulnerable families with Govt PHC &
                              BBMP Officials
                              <dd>
